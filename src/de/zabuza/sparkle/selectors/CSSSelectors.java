...
public final class CSSSelectors {
	...
	/**
	 * Selector that corresponds to an input field for entering chat messages for
	 * submission.
	 */
	...
	/**
	 * Selector that corresponds to the field for submitting direct chat messages.
	 */
	public static final String CHAT_FORM_SUBMIT_DIRECT = "input.submitsagen";
	/**
	 * Selector that corresponds to the field for submitting global chat messages.
	 */
	public static final String CHAT_FORM_SUBMIT_GLOBAL = "input.submitglobalchat";
	/**
	 * Selector that corresponds to the field for submitting group chat messages.
	 */
	public static final String CHAT_FORM_SUBMIT_GROUP = "input.submitgroup";
	/**
	 * Selector that corresponds to the field for submitting scream chat messages.
	 */
	public static final String CHAT_FORM_SUBMIT_SCREAM = "input.submitschreien";
	/**
	 * Selector that corresponds to the field for submitting whisper chat messages.
	 */
	...
	/**
	 * Selector that corresponds to the destination selector element of an activated
	 * compressed magic sphere item.
	 */
	...
	/**
	 * Selector that corresponds to an element that holds the name of an equipped
	 * item.
	 */
	...
	/**
	 * Selector that corresponds to an element that holds the attack points of the
	 * player.
	 */
	public static final String ITEM_PLAYER_ATTACK_POINTS = "p#listrow_attackp";
	/**
	 * Selector that corresponds to an element that holds the name of the equipped
	 * attack weapon.
	 */
	public static final String ITEM_PLAYER_ATTACK_WEAPON = "p#listrow_attackw";
	/**
	 * Selector that corresponds to an element that holds the defense points of the
	 * player.
	 */
	...
	/**
	 * Selector that corresponds to an element that holds the amount of life points
	 * the player has.
	 */
	public static final String ITEM_PLAYER_LIFE_POINTS = "p#listrow_lifep span";
	/**
	 * Selector that corresponds to an element that holds the maximal amount of life
	 * points the player can have.
	 */
	...
	/**
	 * Selector that corresponds to an element that holds the amount of speed the
	 * player has.
	 */
	public static final String ITEM_PLAYER_SPEED = "p#listrow_int span";
	/**
	 * Selector that corresponds to an element that holds the statuses the player
	 * has.
	 */
	...
	/**
	 * Selector that corresponds to an anchor which closes the abort dialog of the
	...
	/**
	 * Selector that corresponds to an anchor which activates the special skill of
	 * the player.
	 */
	...
	/**
	 * Selector that corresponds to an anchor, in the login pop-up, which continues
	 * to the game.
	 */
	...
	/**
	 * Selector that corresponds to an anchor that performs a regular attack on a
	 * NPC.
	 */
	...
	/**
	 * The post-part of a selector that corresponds to an anchor which moves in a
	 * given direction.
	 */
	 ...
	 */
	public static final String MAP_MOVE_EAST_ANCHOR = MAP_MOVE_ANCHOR_PRE + "1, 0" + MAP_MOVE_ANCHOR_POST;

	/**
	 * Selector that corresponds to an anchor which moves to north.
	 */
	public static final String MAP_MOVE_NORTH_ANCHOR = MAP_MOVE_ANCHOR_PRE + "0, -1" + MAP_MOVE_ANCHOR_POST;
	/**
	 * Selector that corresponds to an anchor which moves to northeast.
	 */
	public static final String MAP_MOVE_NORTHEAST_ANCHOR = MAP_MOVE_ANCHOR_PRE + "1, -1" + MAP_MOVE_ANCHOR_POST;

	/**
	 * Selector that corresponds to an anchor which moves to northwest.
	 */
	public static final String MAP_MOVE_NORTHWEST_ANCHOR = MAP_MOVE_ANCHOR_PRE + "-1, -1" + MAP_MOVE_ANCHOR_POST;
	/**
	 * Selector that corresponds to an anchor which moves to south.
	 */
	public static final String MAP_MOVE_SOUTH_ANCHOR = MAP_MOVE_ANCHOR_PRE + "0, 1" + MAP_MOVE_ANCHOR_POST;

	/**
	 * Selector that corresponds to an anchor which moves to southeast.
	 */
	public static final String MAP_MOVE_SOUTHEAST_ANCHOR = MAP_MOVE_ANCHOR_PRE + "1, 1" + MAP_MOVE_ANCHOR_POST;
	/**
	 * Selector that corresponds to an anchor which moves to southwest.
	 */
	public static final String MAP_MOVE_SOUTHWEST_ANCHOR = MAP_MOVE_ANCHOR_PRE + "-1, 1" + MAP_MOVE_ANCHOR_POST;
	/**
	 * Selector that corresponds to an anchor which moves to west.
	 */
	public static final String MAP_MOVE_WEST_ANCHOR = MAP_MOVE_ANCHOR_PRE + "-1, 0" + MAP_MOVE_ANCHOR_POST;
	/**
	...
	/**
	 * Selector that corresponds to an anchor that surely logs outs from the current
	 * session.
	 */
	 ...
	 * present or contains no text the player is able to move, else he has to wait
	 * the given time.
	 */
