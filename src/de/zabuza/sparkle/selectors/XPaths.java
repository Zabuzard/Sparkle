...
public final class XPaths {
	...
	/**
	 * Selector that corresponds to the element containing all information about
	...
	/**
	 * The post-part of a selector that corresponds to an element which contains
	 * the maximal level of the skill with the given name.
	 */
	public static final String ITEM_SKILL_MAXIMAL_LEVEL_POST = "')]/parent::td/following-sibling::td/following-sibling::td";
	/**
	 * Selector that corresponds to the element containing all information about
	 * the maximized skills.
	 */
	...
	/**
	 * Selector that indicates, if present, whether the skill menu is opened or
	 * not.
	 */
	public static final String ITEM_SKILL_MENU_OPENED = "//p[@class='listcaption' and contains(text(), 'Deine trainierbaren')]";
	/**
	 * The post-part of a selector that corresponds to an anchor which starts
	 * the training of the skill with the given name.
	 */
	...
	/**
	 * The pre-part of a selector that corresponds to an element which contains
	 * the maximal level of the skill with the given name.
	 */
